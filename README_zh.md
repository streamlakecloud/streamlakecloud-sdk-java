...
StreamLake SDK 是为 Java 编程语言提供的快手视频云（StreamLake）官方 SDK。StreamLake 提供企业级视频云能力；[CyberCut](https://cybercut.ai) 是基于 StreamLake 的 AI 视频创作平台，本 SDK 中的多模态融合（Omni Fusion）等能力可直接用于 CyberCut 工作流集成。
...
- StreamLake 官网：[https://www.streamlake.com](https://www.streamlake.com)
- CyberCut 官网：[https://cybercut.ai](https://cybercut.ai)
...
### v1.0.33
- `SubmitOmniFusionTask` 的 `video_generation_request` 新增 `enable_subtitle` 字段，支持控制是否开启字幕（默认 true）
